...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeRequests() //Объект http
                .antMatchers("/admin/**").hasRole("ADMIN")
                .antMatchers("/home", "/style/**", "/").permitAll() //permitAll кто угодно
                .antMatchers("/auth/login", "/auth/register").permitAll()// authenticated что доступно уинтифицированным
